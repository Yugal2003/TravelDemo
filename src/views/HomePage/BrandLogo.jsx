    ...
    <div>
        <div>{/* max-w */}
            <div className='w-full justify-center items-center mx-auto flex flex-col'>
                ...
                <div className='w-full border border-black justify-center items-center mx-auto flex flex-col max-w-auto  bw:max-w-[540px] md:max-w-[720px] bs:max-w-[960px] bm:max-w-[1140px] 2xl:max-w-[1320px] px-[12px]'>
                    <div className='flex w-full border border-black items-center justify-center bs:justify-around flex-wrap gap-y-[20px] gap-x-[30px] bs:gap-y-[15px] bs:gap-x-[24px]'>
                        {/* first */}
                        <div className=''>
