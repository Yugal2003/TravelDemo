    ...
    <div>
         <div>{/* max-w */}
            <div className='w-full justify-center items-center mx-auto flex flex-col max-w-[1630px]'>
                {/* first */}
                <div className='text-center w-full px-[12px]'>
                    ...
                    <h2 style={{visibility:"visible",animationDuration:"0.8s",animationDelay:"0.2s",animationName:"fadeInUp"}} className='font-semibold text-[38px] bs:text-[44px] 2xl:text-[56px] leading-[1.327em] mb-0 travel_top_text text-[#102039]'>Last Minute Amazing Deals</h2>
                </div>
                    ...
                    <div className='w-[100%] bs:w-[50%] max-w-[100%] px-[12px]'>
                        <div style={{boxShadow: "0px 0px 45px 0px rgba(0, 0, 0, 0.1)"}} className='sm:pr-[20px] bm:pr-[30px] 3xl:pr-[60px] gap-[20px] bm:gap-[30px] flex flex-col sm:flex-row bg-white min-h-[350px] bm:min-h-[400px]'>
                            ...
                            <div className='pt-[10px] pr-[20px] pb-[30px] pl-[20px] sm:pt-[30px] sm:pr-[0px] sm:pb-[30px] sm:pl-[0px] flex items-center'>
                                <div>
                                    {/* first */}
                                    <div className='flex items-center gap-[15px] mb-[17px] text-[16px]'>
                                    ...
                                    <h2 className='mb-[20px] font-semibold text-[24px] leading-[1.333em] text-[#102039] travel_top_text'>
                                        <a href="https://example.com" target="_blank" rel="noopener noreferrer" className='overflow-hidden shadow-none font-semibold text-[20px] bs:text-[22px] 2xl:text-[24px] leading-[1.333em] travel_top_text hover:text-[#3fd0d4]' 
                                        style={{
                                        ...
                                        >Our Business Thrives To Contribute Global</a>
                                    </h2>

                                    <p className='mb-[35px] overflow-hidden mt-0 deliver text-[#666666]'
                                     style={{
                                        textOverflow: "ellipsis",
                                        display: "-webkit-box",
                                        WebkitLineClamp: 3,
                                    ...
                                    <div className='flex items-center justify-between pl-[20px] bg-[#f8f8f8]' style={{WebkitBoxAlign:"center",WebkitBoxPack:"justify"}}>
                                        <a href="https://example.com" target="_blank" rel="noopener noreferrer" className='shadow-none text-[#666666] deliver flex items-center gap-x-1 bs:gap-x-2 hover:text-[#3fd0d4]' style={{transition: "all 0.3s ease"}}>
                                        ...
                                        <a href="https://example.com" target="_blank" rel="noopener noreferrer" className='deliver flex items-center gap-[8px] text-white shadow-none hover:bg-[#3fd0d4] bg-[#102039] custom-clip-path pt-[14px] pr-[20px] pb-[14px] pl-[40px] xl:pr-[25px] xl:pl-[53px]' style={{transition: "all 0.4s ease"}}>
                                            More
                                ...
                                <div>
                                    ...
                                    <h2 className='mb-[20px] font-semibold text-[24px] leading-[1.333em] text-[#102039] travel_top_text'>
                                        ...
                                        style={{
                                            ...
                                            WebkitLineClamp: 2,
                                            WebkitBoxOrient: "vertical"}}
                                        >Designing Better Linke Website And Email</a>
                                    </h2>
                                    ...
                                    <div className='flex items-center justify-between pl-[20px] bg-[#f8f8f8]' style={{WebkitBoxAlign:"center",WebkitBoxPack:"justify"}}>
                                        <a href="https://example.com" target="_blank" rel="noopener noreferrer" className='shadow-none text-[#666666] deliver flex items-center gap-x-1 bs:gap-x-2  hover:text-[#3fd0d4]' style={{textDecoration:"none",transition: "all 0.3s ease"}}>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <mask id="mask01" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="20">
                                                <rect width="20" height="20" fill="#D9D9D9"></rect></mask>
                                                <g mask="url(#mask01)"><path d="M1.66675 18.3337V3.33366C1.66675 2.87533 1.83008 2.48283 2.15675 2.15616C2.48286 1.83005 2.87508 1.66699 3.33341 1.66699H16.6667C17.1251 1.66699 17.5176 1.83005 17.8442 2.15616C18.1704 2.48283 18.3334 2.87533 18.3334 3.33366V13.3337C18.3334 13.792 18.1704 14.1845 17.8442 14.5112C17.5176 14.8373 17.1251 15.0003 16.6667 15.0003H5.00008L1.66675 18.3337ZM3.33341 14.3128L4.31258 13.3337H16.6667V3.33366H3.33341V14.3128Z" fill="currentColor"></path></g>
