    ...
    <div>
        <div> {/* max-w */}
          <div className='w-full justify-center items-center mx-auto max-w-auto  bw:max-w-[540px] md:max-w-[720px] bs:max-w-[960px] bm:max-w-[1140px] 2xl:max-w-[1320px]'>
              <div className='flex flex-wrap gap-y-[40px] gap-x-0'>
                {/* left side */}
                <div className='w-[100%] bw:w-[50%] max-w-[100%] px-[12px]'>
                  <div className='relative pb-[6px] pl-[45px]'>
                    {/* before */}
                    <div className="guide-section-before">
                    </div>
                ...
                <div className='ml-0 bs:ml-[8.333%] w-auto bs:w-[41.666%] max-w-[100%]'>
                    ...
                    <div ref={ref} className='gap-y-[24px] relative flex flex-wrap w-full'>
                        <div className='absolute h-[110px] w-[110px] right-[-50px] top-[-65px] bg-[#3fd0d4] hidden bs:flex items-center justify-center flex-shrink-0 max-w-[100%] px-0 bs:px-[1.5rem] rounded-[50%]'>
