          ...
          <div className='w-full flex flex-col bs:flex-row justify-center items-center mx-auto'>
                ...
                <div className='flex gap-[40px] bs:gap-0 flex-col bs:flex-row w-full items-center justify-center max-w-full  bw:max-w-[540px] md:max-w-[720px] bs:max-w-[960px] bm:max-w-[1140px] 2xl:max-w-[1320px]'>
                    ...
                    <div className='bs:w-[50%] bs:ml-[8.33%] px-[0.8rem]'>
                        ...
                        <div className='mt-2'>
                            <h1  className='text-[#102039] w-[80%] bw:h-full leading-[3rem] 2xl:leading-[4.5rem] travel_top_text font-bold text-[38px] bs:text-[44px] 2xl:text-[56px]'>We are Professional Planners For your</h1>
                        </div>
                        ...
                        <div className='flex gap-6 mt-6 bs:mt-6 2xl:mt-4'>
                          ...
                          <div>
                             <h1 className='lorem text-[15px] text-[#666666]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. sed do eiusmod tem por incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam Lorem ipsum dolor sit amet, consectetur adipiscing elit. sed do</h1>
                          </div>
                        </div>
                        ...
                        <div className='flex gap-6 mt-6'>
                          ...
                          <div>
                             <h1 className='text-[#3fd0d4] font-semibold lorem text-[17px]'>Speak to our Destination Experts at Direct Call +1 546 378 654</h1>
                          </div>
                        </div>
                        ...
                        <div className='flex flex-col gap-5 mt-9'>
                          <div className='flex gap-2 items-center'>
                            <span className='rounded-full p-[5px] text-[18px] lorem bg-[#3fd0d4]'><MdDone size={14} color='white'/></span>
                        ...
                        <div className='mt-12 flex w-[34%] p-3 rounded-md justify-center items-center gap-2 hover:bg-[#102039] bg-[#3fd0d4]'>
                          <div className=''>
