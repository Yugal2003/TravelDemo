    ...
    <div>
        <div className=' bg-[#ecffff]'>
            ...
            <div className='w-full mx-auto flex flex-col max-w-auto  bw:max-w-[540px] md:max-w-[720px] bs:max-w-[960px] bm:max-w-[1140px] 2xl:max-w-[1320px] px-[12px]'>
                {/* first */}
                <div>
                    <h3 className='mb-[5px] uppercase tracking-[5px] text-[#3fd0d4] font-normal text-[24px] leading-[1.333em] text_lets'>POPULAR DESTINATION</h3>
                    <h2 className='font-semibold text-[56px] leading-[1.327em] travel_top_text'>Popular Destinations</h2>
                </div>
                <div className='h-[40px] bs:h-[55px] w-full'></div>
                <div 
                  className='flex'
                ...
                >
                    {/* first */}
                    <div 
                      className='h-[450px] flex items-end relative overflow-hidden cursor-pointer' 
                      style={{
                        transition: "all 0.4s ease",
                        flex: activeIndex === 0 ? 3 : 1.3
                      }}
                      onMouseEnter={() => setActiveIndex(0)}
                    >
                        <a className='absolute h-[100%] w-[100%] left-0 top-0 shadow-none bg-cover bg-no-repeat bg-center' style={{transition: "all 0.4s ease", backgroundImage: `url(${img1})`}}></a>
                        <a className='h-[55px] w-[55px] bg-white text-[#102039] right-[18px] top-[24px] z-[1] rounded-full shadow-none flex items-center justify-center absolute' style={{
                            transition: "all 0.4s ease",
                            transform: activeIndex === 0 ? "translate(0px, 0px) scale(1) rotate(360deg)" : "translate(0px, 0px) scale(0) rotate(360deg)"
                          }}>
                            <MdKeyboardArrowRight size={28}/>
                        </a>
                        <div className='relative z-[2] w-[100%] py-[44px] px-[34px]' style={{
                            transition: "all 0.4s ease",
                            ...
                            <h2 className='text-white text-[35px] leading-[1.34em]'>
                                <a className='shadow-none travel_top_text font-bold hover:underline' style={{transition: "all 0.3s ease"}}>Eiffel Tower</a>
                            </h2>
                        </div>
                    </div>
                    {/* second */}
                    ...
                    >
                        ...
                        <div className='relative z-[2] w-[100%] py-[44px] px-[34px]' style={{
                            ...
                            <h2 className='text-white text-[35px] leading-[1.34em]'>
                                <a className='shadow-none travel_top_text font-bold hover:underline' style={{transition: "all 0.3s ease"}}>Pryde Mountains</a>
                            </h2>
                        </div>
                    </div>
                    {/* third */}
                    ...
                    >
                        ...
                        <div className='relative z-[2] w-[100%] py-[44px] px-[34px]' style={{
                            ...
                            <h2 className='text-white text-[35px] leading-[1.34em]'>
                                <a className='shadow-none travel_top_text font-bold hover:underline' style={{transition: "all 0.3s ease"}}>Lao Lading Island</a>
                            </h2>
                        </div>
                    </div>
                    {/* fourth */}
                    ...
                    >
                        ...
                        <div className='relative z-[2] w-[100%] py-[44px] px-[34px]' style={{
                            ...
                            <h2 className='text-white text-[35px] leading-[1.34em]'>
                                <a className='shadow-none travel_top_text font-bold hover:underline' style={{transition: "all 0.3s ease"}}>Ton Kwen Temple</a>
                            </h2>
                        </div>
                    </div>
                    {/* five */}
                    ...
                    >
                        ...
                        <div className='relative z-[2] w-[100%] py-[44px] px-[34px]' style={{
                            ...
                            <h2 className='text-white text-[35px] leading-[1.34em]'>
                                <a className='shadow-none travel_top_text font-bold hover:underline' style={{transition: "all 0.3s ease"}}>Taj Mahal</a>
                            </h2>
                        </div>
                    </div>
                </div>
