          ...
          <div style={{backgroundImage:`url(${footer_img})`}} className='relative w-full bg-[#102039] text-white bg-cover bg-no-repeat bg-center mt-[200px] bs:mt-0'>
            ...
            <div className='w-[100%] mx-auto max-w-auto  bw:max-w-[540px] md:max-w-[720px] bs:max-w-[960px] bm:max-w-[1140px] 2xl:max-w-[1320px] px-[12px]'>
              <div className='border border-red-600 flex flex-col bs:flex-row mt-[30px] bs:mt-0 gap-0 bs:gap-y-[40px] bs:gap-x-0 bs:pt-[100px] bs:pb-[60px] bs:ml-[-25px] bs:mr-[-25px] text-white'>
                  ...
                  {/* <div className='flex-1 py-[15px] px-[25px] text-white'>
                    <div className=''>
                      <h3 className='mb-[20px] bs:mb-[35px] text-white font-semibold text-[20px] bs:text-[22px] 2xl:text-[24px] leading-[1.333em] travel_top_text'>Contact Info</h3>
                      <div className=''>
                        <ul className='p-0 my-0 mx-[-7px] flex flex-wrap gap-y-[18px] gap-x-0' style={{listStyle:"none"}}>
                          <li className='mb-0 w-[50%] py-0 px-[7px] deliver hover:text-[#3fd0d4] cursor-pointer'>
                            <a className='' style={{textDecoration:"none",transition: "all 0.3s ease"}}>Santorini, Greece</a>
                          </li>
                          <li className='mb-0 w-[50%] py-0 px-[7px] deliver hover:text-[#3fd0d4] cursor-pointer'>
                            <a className='' style={{textDecoration:"none",transition: "all 0.3s ease"}}>Machu Picchu, Peru</a>
                          </li>
                          <li className='mb-0 w-[50%] py-0 px-[7px] deliver hover:text-[#3fd0d4] cursor-pointer'>
                            <a className='' style={{textDecoration:"none",transition: "all 0.3s ease"}}>New York City, USA</a>
                          </li>
                          <li className='mb-0 w-[50%] py-0 px-[7px] deliver hover:text-[#3fd0d4] cursor-pointer'>
                            <a className='' style={{textDecoration:"none",transition: "all 0.3s ease"}}>Rome, Italy</a>
                          </li>
                          <li className='mb-0 w-[50%] py-0 px-[7px] deliver hover:text-[#3fd0d4] cursor-pointer'>
                            <a className='' style={{textDecoration:"none",transition: "all 0.3s ease"}}>Paris, France</a>
                          </li>
                          <li className='mb-0 w-[50%] py-0 px-[7px] deliver hover:text-[#3fd0d4] cursor-pointer'>
                            <a className='' style={{textDecoration:"none",transition: "all 0.3s ease"}}>Africa Portugal Mexico</a>
                          </li>
                          <li className='mb-0 w-[50%] py-0 px-[7px] deliver hover:text-[#3fd0d4] cursor-pointer'>
                            <a className='' style={{textDecoration:"none",transition: "all 0.3s ease"}}>Machu Picchu, Peru</a>
                          </li>
