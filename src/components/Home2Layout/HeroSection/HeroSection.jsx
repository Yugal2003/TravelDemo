...
const HeroSection = () => {
  ...
  return (
    <div>
        <div className='h-[780px] 2xl:h-[880px] 3xl:h-auto pt-[205px] bs:pt-[145px] pb-[30px] bs:pb-[30px] bg-[#c0ffff]'>
            <div className='pl-[8%] 3xl:pl-0 max-w-[1920px] w-[100%] relative mx-auto flex items-center h-[100%] z-[2]'>
                {/* hero img */}
                <div className='max-w-[48%] absolute right-[3%] top-[57%]' style={{transform:"translateY(-50%)"}}>
                    <img src={heroImg} alt='hero_img' className='border-none rounded-none shadow-none h-auto max-w-[100%]' style={{verticalAlign:"middle"}}/>
                </div>
                {/* hero text */}
                <div className='relative z-[2] max-w-[580px] 2xl:max-w-[780px]'>
                <motion.div 
                        ...
                        >
                    <h3 className='mb-[15px] text-[#3fd0d4] font-semibold text-[20px] bs:text-[22px] 2xl:text-[24px] leading-[1.333em] travel_top_text'>Find Next PlaceTo Visit</h3>    
                </motion.div>
                    <h1 className='mb-[30px] font-semibold text-[42px] bw:text-[56px] bm:text-[60px] 2xl:text-[75px] leading-[1.11em] travel_top_text text-[#102039]'>Tour Travel & Adventure Camping</h1>
